...
class Network(object):
    ...
    def __init__(self, sizes):
        ...
        takes:
            sizes -- list of layer sizes
                example: sizes = [2, 3, 1]
                         2 neurons in 1st layer
                         3 neurons in 2nd layer
                         1 neuron in 3rd layer
        """
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data = None):
        ...
        takes:
            traing_data     -- list of tuples (x, y) to be trained on
    ...
    def backprop(self, x, y):
        """
        returns:
            a tuple (nabla_b, nabla_w) representing the gradient for the cost function C_x.
